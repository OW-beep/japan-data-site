...
import { getPrefectureStats } from "@/lib/getPrefectureStats";
import { prefectureNotes } from "@/lib/prefectureNotes";
...
export default async function Page({
  ...
  return (
    ...
    >
      ...
      {(() => {
        const stats = getPrefectureStats(pref);
        return stats ? <PrefectureSummary stats={stats} /> : null;
      })()}

      {prefectureNotes[pref] && (
        <PersonalNote>{prefectureNotes[pref]}</PersonalNote>
      )}
