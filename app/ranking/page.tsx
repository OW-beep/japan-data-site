...
const rankings = [
  ...
  { href: "/ranking/divorce-rate", emoji: "💔", label: "離婚率ランキング" },
  ...
  { href: "/ranking/corporate-growth", emoji: "🏢", label: "新設法人純増数ランキング" },
  ...
  { href: "/ranking/pharmacist", emoji: "💊", label: "薬剤師数ランキング" },
  { href: "/ranking/hospital", emoji: "🏥", label: "病院数ランキング" },
