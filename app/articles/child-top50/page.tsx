    ...
    >
      ...
      <div style={box}>
        ...
        <p>
          ...
          沖縄県は1.54と、全国平均の1.15を大きく上回って
          います。出生率の高さがそのまま子ども比率の高さに
          つながっている典型例と言えるでしょう。
        </p>
      ...
      <div style={box}>
        ...
        <p>
          子ども人口割合ランキングからは、沖縄県を
          中心とする南西日本の子育て環境の強さ、
          大都市近郊のベッドタウンにおける宅地開発の
          効果、そして離島や小規模自治体特有のデータの
          振れ幅という、少なくとも3つの異なる傾向を
          読み取ることができました。単純に「子どもが
          多い・少ない」という順位だけを見るのではなく、
          その背景にある人口規模や地理的条件、
          産業構造まで踏み込んで考えることで、
          ランキングはより豊かな情報源になります。
          本サイトでは今後も、こうした多角的な視点からの
          分析記事を充実させていく予定です。
        </p>
      </div>
    </ArticleLayout>
