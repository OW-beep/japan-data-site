...
export default function Page() {
  ...
  const faq = [
    {
      q: "生活基盤充実度指数とは何ですか？",
      a: "人口や高齢化率だけでは「暮らしやすさ」は測れないと考え、日常生活に関わる3つのデータを組み合わせました。人口あたりの商業集積(小売店・飲食店の数)、人口あたりの公民館数、そして空き家率(こちらは低いほど良いので逆向きに)を、それぞれ統計的に標準化して合算しています。",
    },
    {
  ...
  return (
    ...
    >
      ...
      <div style={box}>
        <h2>「空き家が多い=衰退」と決めつけないでほしい</h2>

        <p>
          このスコアで最も伝えたいのは、空き家率という
          数字の危うさです。熱海市や那須町の高い空き家率は、
          過疎による本当の空き家というより、別荘・セカンド
          ハウスとして季節的に使われている住宅が多いことの
          表れです。人口減少地域の空き家と、観光地の別荘を
          同じ「空き家率」という数字で並べて比較すること
          自体に無理がある、というのが今回の集計を通じて
          得た実感です。スコアの順位そのものより、なぜその
          順位になったのかという背景を見ることをおすすめ
          します。
        </p>
      </div>
