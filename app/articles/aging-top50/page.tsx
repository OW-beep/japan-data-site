    ...
    >
      ...
      <div style={box}>
        ...
        <p>
          ...
          全国計の高齢化率(約27%)より
          {(average - 27).toFixed(1)}ポイント高くなっています。
      ...
      <div style={box}>
        ...
        <p>
          高齢化率が29%を超える自治体は今回のTOP50を含め
          全国に多数存在し、今後全国平均自体がさらに
          上昇していくと見込まれています。本サイトでは、
          高齢化率とあわせて財政力指数のランキングも
          掲載しており、高齢化が進む自治体の財政状況を
          数値で確認できます。
        </p>
      ...
      <div style={box}>
        ...
        <PersonalNote>
          自治体職員をしていたころ、「高齢化は地方の問題」
          という意識がどこかにありました。ですが実際には、
          都市近郊のニュータウンでも高齢化は確実に進んでいます。
          しかも、かつて同じ世代が一斉に入居した地域ほど、
          ある時期を境に一気に高齢化率が跳ね上がる傾向があり、
          このランキングの下位(まだ高齢化率が低い側)にいる
          自治体の中にも、実は数年後に急上昇する予備軍が
          含まれている可能性があります。今の順位だけでなく、
          その自治体がいつ人口が増えた地域なのかも、あわせて
          見ておきたいポイントです。
        </PersonalNote>
      </div>
    </ArticleLayout>
