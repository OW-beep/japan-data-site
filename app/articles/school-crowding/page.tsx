  ...
  return (
    ...
    >
      ...
      <div style={box}>
        ...
        <p>
          このほか、大都市近郊のベッドタウンも上位に並びました。
        </p>

        <div style={{ margin: "12px 0" }}>
          <span className="stat-chip">埼玉県 朝霞市</span>
          <span className="stat-chip">埼玉県 戸田市</span>
          <span className="stat-chip">愛知県 長久手市</span>
          <span className="stat-chip">石川県 野々市市</span>
        </div>
