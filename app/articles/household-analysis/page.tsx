  ...
  return (
    ...
    >
      ...
      <div style={box}>
        ...
        <PersonalNote>
          単独世帯の割合は、体感よりずっと高いと感じます。
          しかも都市部では「若年単身」と「高齢単身」が
          同時に増えているのですが、この2つは中身がまったく
          別物です。現場では、高齢単身の方の見守り・孤立対策が
          課題になる一方、若年単身の方は入れ替わりが激しく
          地域とのつながりを持ちにくいという、別の難しさが
          ありました。もう一つ意外だったのは、地方でも
          単独世帯が増えている点です。人口そのものは
          減っていても、二世帯・三世帯だった家が世帯分離する
          ことで単独世帯が増えるケースがあり、「人口が減れば
          世帯も減る」とは限らないと気づかされました。
        </PersonalNote>
      </div>
