    ...
    >
      ...
      <div style={box}>
        ...
        <p>
          ...
          地域です。産炭地以外の自治体も上位に含まれており、
          必ずしも旧産炭地だけが要因のすべてではありませんが、
          筑豊地方の集中度の高さは、このランキングの際立った
          特徴だと言えます。
        </p>

        <div style={{ margin: "12px 0" }}>
          <span className="stat-chip">奈良県 三宅町</span>
          <span className="stat-chip">青森県 今別町</span>
          <span className="stat-chip">福島県 小野町</span>
          <span className="stat-chip">群馬県 大泉町</span>
        </div>
      </div>
