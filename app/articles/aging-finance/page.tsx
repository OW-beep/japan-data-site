    ...
    >
      ...
      <div style={box}>
        ...
        <div className="pull-note">
          <strong>パターン1・温泉・リゾート観光地({onsenCount}自治体)</strong>
          <div style={{ margin: "8px 0" }}>
            <span className="stat-chip">静岡県 熱海市</span>
            <span className="stat-chip">静岡県 伊東市</span>
            <span className="stat-chip">神奈川県 湯河原町</span>
            <span className="stat-chip">栃木県 那須町</span>
          </div>
          これらの自治体では、住民自体は高齢化していても、
          旅館・ホテルなどの宿泊施設や別荘・保養所が生み出す
          固定資産税収入が大きく、住民の年齢構成とは切り離された
          形で税収基盤が維持されています。
        </div>

        <div className="pull-note">
          <strong>パターン2・原子力発電所の立地自治体</strong>
          <div style={{ margin: "8px 0" }}>
            <span className="stat-chip">愛媛県 伊方町(伊方発電所)</span>
            <span className="stat-chip">石川県 志賀町(志賀原子力発電所)</span>
          </div>
          発電所という大規模な固定資産に対する固定資産税収入に加え、
          国からの電源立地地域対策交付金といった財政支援も財政力
          指数を押し上げる要因になっています。人口が少なく
          高齢化率も高い町村であっても、大規模発電施設が立地
          しているだけで財政指標が大きく変わる典型的な例です。
        </div>
