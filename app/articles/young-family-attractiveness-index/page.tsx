...
export default function Page() {
  ...
  const faq = [
    {
      q: "子育て世代吸引力指数とは何ですか？",
      a: "「子育てしやすい街」を1つの数字だけで語るのは無理があると考え、性質の異なる3つのデータをかけ合わせました。保育所への入りやすさ(子ども1,000人あたりの定員数)、若い世代が実際に転入してきているか(20代純移動率)、婚姻件数の3つを統計的に標準化して合算しています。",
    },
    {
  ...
  return (
    ...
    >
      ...
      <div style={box}>
        <h2>移住先を選ぶ前に知っておきたいこと</h2>

        <p>
          このスコアに婚姻率が含まれていますが、婚姻率
          ランキング分析の記事で触れた通り、東京都心区の
          婚姻件数には「未婚のまま転入した若年層が多く住む
          ことによる分母の押し上げ」という統計上の癖が
          あります。つまり東京都心区の高スコアは、必ずしも
          「結婚・子育てのしやすさ」をそのまま意味する
          わけではありません。また保育料や医療費助成の
          手厚さは今回の集計に含まれていないため、実際に
          移住先を検討する際は、このスコアだけでなく
          自治体独自の子育て支援制度もあわせて調べることを
          おすすめします。
        </p>
      </div>
