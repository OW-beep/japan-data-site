...
//
// 【実行済み】2026年8月に一度実行し、data/cities.json への
// マージは完了済み（下記 FIELD_MAP の「2026-08 第2弾」コメント
// 参照）。SSDSE-A-2026.csv の内容が統計センター側で更新されない
// 限り、再実行しても結果は変わらない（冪等）。年次データが
// 更新されたタイミング（例年6月頃）で再実行すれば、最新の
// 統計に更新できる。
// ------------------------------------------------------------------
